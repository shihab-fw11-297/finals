...
- [Implemented strategy rules](./STRATEGY_IMPLEMENTATION_REFERENCE.md)
- [Signal flow and follow-through scoring](./SIGNAL_FLOW_DETAILS.md)
- [Signal generation and execution guide](./SIGNAL_EXECUTION_GUIDE.md)
- [Trader-facing signal analysis guide](./TRADER_SIGNAL_ANALYSIS.md)
