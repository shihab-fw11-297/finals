          ...
          <div className="max-h-72 overflow-auto">
            <table className="min-w-[1320px] w-full text-left text-xs">
              <thead className="sticky top-0 bg-slate-100 text-slate-600">
                <tr>{["Setup", "Direction", "Type", "Setup score", "Req setup", "Final score", "Req signal", "Status", "Window", "Entry", "SL", "TP", "RR", "Rejected", "Reason", "Next action"].map((item) => <th key={item} className="px-3 py-2 font-semibold">{item}</th>)}</tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
